...
?>
	...
	echo"<div id='wrapperFicha' align='center'>";
		...
		*/
		...
		if($PreventivasCorrectivasPendientes != null){

			echo "<table border='0' align='center'>";

				echo "<tr >";
					echo "<td colspan=4 align='center'><h2>Acciones Preventivas y Correctivas Pendientes</h2></td>";
				echo "</tr>";

				echo "<tr >";
					echo "<td align='center'><h4>Clave</h4></td>";
					echo "<td align='center'><h4>Titulo</h4></td>";
					echo "<td align='center'><h4>Fecha</h4></td>";
					echo "<td align='center'><h4></h4></td>";
				echo "</tr>";

				foreach($PreventivasCorrectivasPendientes as $registro){
					echo "<tr height='40px'>";
						echo "<td width='20%'>".$registro["xt_claveAccion"]."</td>";
						echo "<td width='60%'><a href='SistemaGestionIntegral/Intranetv2/fichaCorrectivav2.php?id=".$registro["xt_claveAccion"]."' onclick='abrirVentana(this.href); return false;'>".$registro["xt_titulo"]."</a></td>";
